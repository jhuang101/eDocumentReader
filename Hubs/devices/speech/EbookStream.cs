...
{
    /// <summary>
    /// A customized audio stream. The EBookStream has a special
    /// feature that if the SR reads number of bytes is less than what
    /// is available, it will hold and wait until the stream is greater
    /// or equals to the number of byte that SR required.
    /// </summary>
    public class EbookStream : Stream
    {
        ...
        {
            //do nothing, we will same audio in the SR class.
        }
