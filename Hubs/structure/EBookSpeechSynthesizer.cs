        ...
        public void generateSynthesisData(Story story)
        {
            ...
            foreach (InstalledVoice iv in synthesizer.GetInstalledVoices())
            {
                ...
                while(p != null){
                    ...
                    "|isHypothesis::False|key::startIndex|value::" + startIndex + "|grammarName::|ruleName::index_" + startIndex + "|duration::" + totalSentenceDuration + "|wavePath::" + EBookUtil.convertAudioToRelativePath(@audioPath) + "\n";
                        writeToFile(data);
